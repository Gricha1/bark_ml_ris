...
class GCPOLAMPEnvironment(POLAMPEnvironment):
  ...
  @property
  def resolution(self):
    return self.environment.agent.dynamic_model.resolution

  @property
  def dt(self):
    return self.environment.agent.dynamic_model.delta_t
  
  @property
  def L(self):
    return self.environment.agent.dynamic_model.wheel_base
